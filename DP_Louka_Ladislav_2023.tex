...
TypeScript. Such comparison is important due to modern applications' proliferation of database
access. The study aims to compare various packages, assessing their flexibility and performance overhead to facilitate an informed decision-making process for developers.} 

\abstractCS{Tato práce se porovnává frameworky objektově relačního mapování (ORM), respektive pro tvorbu SQL dotazů v jazyce JavaScript. Práce se zaměřuje na podporu jazyka TypeScript. Používání ORM je běžně využito pro úsporu času při vývoji pomocí abstrakce, kterou balíčky poskytují. Cílem studie je porovnat různé balíčky, posoudit jejich flexibilitu a výkonnostní režii a usnadnit tak vývojářům informované rozhodování a použití a případném výběru.}
...
\chapter{Contents of attachments}

%change appropriately

\begin{figure}
	\dirtree{%
		.1 readme.txt\DTcomment{the file with attachment structure and }.
