...
\begin{landscape}
    \begin{figure}
        ...
        \centering
        \includegraphics[width=0.9\paperwidth,height=\paperheight,keepaspectratio]{HTMLReporter}
    \end{figure}
\end{landscape}
...
\begin{figure}
    \caption{Case insensitive pattern (ilikeQuery) Results}
    \label{fig:ilikeQuery}
    \begin{tikzpicture}
    \begin{axis}[
        ybar,
        ylabel={Time (ms)},
    ...
    \addplot coordinates {
        (@Databases/Pg,1183.936791994609) [1183.9]
        (Knex,2468.4686490083113) [2468.5]
        (Kysely,1503.6159000019543) [1503.6]
        (MikroORM,2787.2151470119134) [2787.2]
        (Objection.js,4025.112294003833) [4025.1]
        (PgTyped,1451.0418069930747) [1451.0]
        (PrismaORM,2566.3222450027242) [2566.3]
        (Sequelize,1687.6608400037512) [1687.7]
        (TypeORM,2008.0603819889948) [2008.1]
        (Zapatos,2353.669042979367) [2353.6]
    };     
\end{axis}
\end{tikzpicture}
\end{figure}
...
\begin{figure}
    \caption{Maximum value query Results}
    \label{fig:maxQuery}
    \begin{tikzpicture}
    \begin{axis}[
        ybar,
    ...
    \addplot coordinates {
        (@Databases/Pg, 690.4659369178116)[690.5]
        (Knex, 1355.8135379850864)[1355.8]
        (Kysely, 840.1355499736965)[840.1]
        (MikroORM, 1030.9561109766364)[1031.0]
        (Objection.js, 1498.9568349830806)[1499.0]
        (PgTyped, 547.8961579725146)[547.9]
        (PrismaORM, 1041.2470909953117)[1041.2]
        (Sequelize, 981.2853820733726)[981.3]
        (TypeORM, 834.7038939222693)[834.7]
        (Zapatos, 656.8966010399163)[656.9]
    };
