\chapter{Framework selection}\label{ch:selection}
...
The quality of the typings provided by the package will be a subject of
...
The one condition that could disqualify a package was the ability to function
